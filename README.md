...
- **Logo** (`/admin/logo`) — upload or replace the profile image in the website header (PNG, JPEG, WebP or GIF, up to 4 MB). Remove it to restore the VN text. Changes are saved immediately.
